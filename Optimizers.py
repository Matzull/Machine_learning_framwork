...
class SGD:
    ...
    def __init__(self, learningRate = 1, decay = 0, momentum = 1):
    ...
    def pre_update(self): 
        if self.learning_rate_decay:
            self.current_learning_rate = self.learning_rate / (1 + self.learning_rate_decay * self.step)
...
class AdaGrad:
    ...
    def uptdate_parameters(self, layer):
        if not hasattr(layer, 'weight_momentums'):
